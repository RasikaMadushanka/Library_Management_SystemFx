...
public interface book_Service {
  ...
  void updatebook(String book_Id,String title,String author,String category,String isbn,String publisher,String publish_year,String description,String language,int copies,String status);
